...
- (void)loadCustomViews
{
    _pushedView.frame = CGRectMake(0, 20+44, _size.width, _size.height-64);
        ...
        self.colorPicker ? [self.colorPicker setFrame:colorPickerFrame] : (self.colorPicker = [[PFColorPicker alloc] initWithFrame:colorPickerFrame]);
        ...
        controlsContainer ? [controlsContainer setFrame:controlsContainerFrame] : (controlsContainer = [[UIView alloc] initWithFrame:controlsContainerFrame]);
        ...
        backdrop ? [backdrop setFrame:backdropFrame] : (backdrop = [[viewClass alloc] initWithFrame:backdropFrame]);
        ...
        hueSlider ? [hueSlider setFrame:sliderFrame] : (hueSlider = [[UISlider alloc] initWithFrame:sliderFrame]);
        ...
        saturationSlider ? [saturationSlider setFrame:sliderFrame] : (saturationSlider = [[UISlider alloc] initWithFrame:sliderFrame]);
        ...
        brightnessSlider ? [brightnessSlider setFrame:sliderFrame] : (brightnessSlider = [[UISlider alloc] initWithFrame:sliderFrame]);
        ...
        alphaSlider ? [alphaSlider setFrame:sliderFrame] : (alphaSlider = [[UISlider alloc] initWithFrame:sliderFrame]);
